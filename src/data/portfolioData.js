...
export const projectsData = [
  {
    ...
    workflow: [
      {
        step: "01",
        phase: "Mission Sizing & Requirements",
        tools: ["FAR Part 25", "Python"],
        desc: "Established long-haul mission profile (7,400 nmi, Mach 0.85, 250 passengers). Formulated fuel-fraction trades comparing BWB volume capacity against baseline Boeing 787-9 architecture.",
        output: "Mission Sizing Matrix & Initial Takeoff Weight Budget",
      },
      {
        step: "02",
        phase: "Parametric Geometry & Lofting",
        tools: ["OpenVSP"],
        desc: "Modeled reflexed centerbody, blended transition fairing, and high-aspect outer wing panels with 33° sweep and non-linear geometric twist to minimize induced drag.",
        output: "3D Parametric CAD Loft & Wetted Area Calculation",
      },
      {
        step: "03",
        phase: "Vortex Lattice Aerodynamics & Trim",
        tools: ["AVL (Athena Vortex Lattice)"],
        desc: "Executed low-fidelity potential flow analysis across cruise, climb, and approach. Computed neutral point, pitching moment derivatives (Cm_alpha), and elevator trim deflection angles.",
        output: "Static Margin & Trim Polar Curves",
      },
      {
        step: "04",
        phase: "Multi-Objective Optimization (PSO)",
        tools: ["Python", "Particle Swarm Optimization"],
        desc: "Formulated gradient-free optimization algorithm across 12 geometric variables. Minimized transonic drag while strictly enforcing internal cabin height and structural bending constraints.",
        output: "Cruise L/D Improved: 24.85 → 25.30",
      },
      {
        step: "05",
        phase: "Monte Carlo Sensitivity Trades",
        tools: ["Latin Hypercube", "NumPy"],
        desc: "Simulated 1,000+ geometric permutations to quantify design space robustness. Discovered aspect ratio drives aerodynamic efficiency while centerbody chord dictates seat-mile economics.",
        output: "Sensitivity Correlation Matrix & Trade Frontiers",
      },
      {
        step: "06",
        phase: "Propulsion & Control Synthesis",
        tools: ["GEnX-1B Data", "Fly-By-Wire Architecture"],
        desc: "Integrated dual high-bypass turbofans on upper aft surface for acoustic shielding and boundary layer ingestion. Designed active control augmentation to stabilize pitch dynamics.",
        output: "Final Converged BWB Configuration Dossier",
      },
    ],
  },
  {
    ...
    workflow: [
      {
        step: "01",
        phase: "Competition Scoring & Constraints",
        tools: ["Python", "Rulebook Synthesis"],
        desc: "Formulated objective function to maximize competition revenue ($/hr). Identified key coupling between volume payload bay (8 tennis balls), motor battery draw, and takeoff ground roll.",
        output: "Parametric Objective Function & 24 Constraint Equations",
      },
      {
        step: "02",
        phase: "Gradient-Based MDO Engine",
        tools: ["JAX", "modOpt", "IPOPT"],
        desc: "Built coupled aerostructural and electrical optimization solver. Simultaneously optimized wingspan, chord, cruise speed, and battery cell configuration under 24 non-linear constraints.",
        output: "Optimal Aircraft Geometric & Electrical Sizing State",
      },
      {
        step: "03",
        phase: "High-Lift Airfoil Analysis",
        tools: ["Neural Foil", "XFLR5"],
        desc: "Evaluated high-camber S1223 and Selig airfoils at low Reynolds numbers (Re ~ 200,000). Applied Prandtl lifting-line theory with 3D induced drag and wingtip vortex corrections.",
        output: "Section Cl_max = 2.1 & 3D Lift/Drag Polars",
      },
      {
        step: "04",
        phase: "Propulsion Dynamometer Matching",
        tools: ["Custom Thrust Stand", "LiPo Telemetry"],
        desc: "Constructed bench dynamometer to test brushless motor kV ratings, ESC thermal dissipation, and APC 13x6.5 propeller thrust vs current draw up to 45A peak discharge.",
        output: "Verified 2.4 kg Static Thrust & Efficiency Curves",
      },
      {
        step: "05",
        phase: "CAD Assembly & Airframe Fabrication",
        tools: ["SolidWorks", "Laser Cutter", "CFRP Spar"],
        desc: "Modeled modular balsa rib structure, carbon fiber pultruded tube main spar, and internal servo linkages in SolidWorks. Fabricated laser-cut ribs and applied heat-shrink Monokote skin.",
        output: "Lightweight High-Strength Airframe (Empty Weight 1.8 kg)",
      },
      {
        step: "06",
        phase: "Flight Test & Envelope Expansion",
        tools: ["RC Radio Telemetry", "Field Flight Trials"],
        desc: "Conducted maiden test flight, verified center-of-gravity balance and stall margin, and executed full-load mission flight test carrying 8 regulation payloads within flight time window.",
        output: "Validated Mission Demonstration & Flight Telemetry",
      },
    ],
  },
  {
